...
<template>
  <div class="aside aside-left d-flex aside-fixed" id="kt_aside">
    ...
    <div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
      ...
      <!--begin::Nav Wrapper-->
      <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid py-5 scroll scroll-pull" data-scroll="true">
        <!--begin::Nav-->
        <ul class="nav flex-column" role="tablist">
          <!--begin::Item-->
          <li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Trigger map">
            <button @click="onSelectTab('map')" class="nav-link btn btn-icon btn-clean btn-lg" :class="{'active': currentTab === 'map'}">
          ...
          <!--end::Item-->
          <!--begin::Item-->
          <li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Projects">
            <button @click="onSelectTab('project')" class="nav-link btn btn-icon btn-clean btn-lg" :class="{'active': currentTab === 'project'}">
              <span class="svg-icon svg-icon-xl">
          ...
          <!--end::Item-->
          <!--begin::Item-->
          <li v-if="$can('view all', 'users')" class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Users">
            <button @click="onSelectTab('user')" class="nav-link btn btn-icon btn-clean btn-lg" :class="{'active': currentTab === 'user'}">
              <span class="svg-icon svg-icon-xl">
                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<!--          </li>-->
      ...
      <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-4 py-lg-10">
        <!--begin::Aside Toggle-->
        <span @click="onToggleSidebar" class="aside-toggle btn btn-icon btn-primary btn-hover-primary shadow-sm" title="Toggle Aside">
          <i class="ki ki-bold-arrow-back icon-sm"></i>
        </span>
        <!--end::Aside Toggle-->

        <!--begin::User-->
        <router-link :to="{name: 'profile.update'}" class="btn btn-icon btn-clean btn-lg w-40px h-40px" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="User profile">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane p-3 px-lg-7 py-lg-5 fade" :class="{'show active': currentTab === 'map'}">
            ...
            <div class="p-2 p-lg-3">
              <div class="d-flex">
                <div class="input-icon h-40px">
                  <input v-model="search.mapSearch" type="text" class="form-control form-control-lg form-control-solid h-40px" placeholder="Search..."/>
                  <span>
                ...
                <router-link :to="{name: 'trigger.map.create'}" class="btn btn-icon btn-default btn-hover-primary ml-2 h-40px w-40px flex-shrink-0" data-toggle="tooltip" title="New Trigger Map" data-placement="bottom">
                  <span class="svg-icon svg-icon-lg">
            ...
            <div class="list list-hover">
              <!--begin::Item-->
              <router-link v-for="map in filteredMapCollection" :to="{name: 'trigger.map.update', params: {map: map.id}}" :key="map.id" class="list-item hoverable p-2 p-lg-3 mb-2">
          ...
          <div class="tab-pane p-3 px-lg-7 py-lg-5 fade" :class="{'show active': currentTab === 'project'}">
            ...
            <div class="p-2 p-lg-3">
              <div class="d-flex">
                <div class="input-icon h-40px">
                  <input v-model="search.projectSearch" type="text" class="form-control form-control-lg form-control-solid h-40px" placeholder="Search..."/>
                  <span>
                    <span class="svg-icon svg-icon-lg">
                      <!--begin::Svg Icon | path:assets/images/svg/icons/General/Search.svg-->
                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <router-link :to="{name: 'marketing.project.create'}" class="btn btn-icon btn-default btn-hover-primary ml-2 h-40px w-40px flex-shrink-0" data-toggle="tooltip" title="New Project" data-placement="bottom">
                  <span class="svg-icon svg-icon-lg">
                    <!--begin::Svg Icon | path:assets/images/svg/icons/Code/Plus.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="list list-hover">
              <!--begin::Item-->
              <router-link v-for="project in filteredProjectCollection" :to="{name: 'marketing.project.update', params: {project: project.id}}" :key="project.id" class="list-item hoverable p-2 p-lg-3 mb-2">
                <div class="d-flex align-items-center">
                  <!--begin::Text-->
                  <div class="d-flex flex-column flex-grow-1 mr-2">
          ...
          <!--begin::Tab Pane-->
          <div v-if="$can('view all', 'users')" class="tab-pane p-3 px-lg-7 py-lg-5 fade" :class="{'show active': currentTab === 'user'}">
            <!--begin::Form-->
            <div class="p-2 p-lg-3">
              <div class="d-flex">
                <div class="input-icon h-40px">
            ...
            <div class="list list-hover">
              <!--begin::Item-->
              <router-link @click.native="switchSession(user)" to="/" v-for="user in filteredUserCollection" :to="{name: 'profile.update', params: {user: user.id}}" :key="user.id" class="list-item hoverable p-2 p-lg-3 mb-2">
                <div class="d-flex align-items-center">
                  <!--begin::Text-->
                  <div class="d-flex flex-column flex-grow-1 mr-2">
