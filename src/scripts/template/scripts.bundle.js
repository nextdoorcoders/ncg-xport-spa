...
export var KTWidgets = function () {
  ...
  var _initChartsWidget4 = function () {
    ...
    var options = {
      ...
      markers: {
        ...
        strokeColor: [KTApp.getSettings()['colors']['theme']['light']['success'],
          KTApp.getSettings()['colors']['theme']['light']['warning']
        ],
        strokeWidth: 3
      }
  ...
  var _initChartsWidget7 = function () {
    ...
    var options = {
      ...
      colors: [KTApp.getSettings()['colors']['theme']['light']['warning'],
      ...
      markers: {
        ...
        strokeColor: [KTApp.getSettings()['colors']['theme']['base']['warning'],
